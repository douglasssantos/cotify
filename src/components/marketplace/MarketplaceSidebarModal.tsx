...
export default function MarketplaceSidebarModal() {
    ...
    <>
      <div className="lefttside-hidden-bar">
        <div className="hsidebar-header bdrb1">
          <h4 className="list-title">Todos os Filtros</h4>
            ...
            <div className="sidebar-accordion">
              <div className="accordion" id="accordionExample2">
                ...
                <div className="card mb20 pb10">
                  <div className="card-header" id="headingMGoodType">
                    <h4>
                      <button
                        className={`btn btn-link ps-0 ${openSections.goodType ? "" : "collapsed"}`}
                        type="button"
                ...
                {/* Status */}
                <div className="card mb20 pb10">
                  <div className="card-header" id="headingMStatus">
                    <h4>
                      <button
                        ...
                        <div key={i} className="switch-style1">
                          <div className="form-check form-switch mb20">
                            ...
                            <label
                              ...
                              htmlFor={`mSwitchStatus-${item.value}`}
                            >
                              {item.label}
                            </label>
                            <span className="right-tags">
                ...
                <div className="card mb20 pb0">
                  <div className="card-header" id="headingMPrice">
                    <h4>
                      <button
                ...
                <div className="card mb20 pb5">
                  <div className="card-header" id="headingMAdm">
                    <h4>
                      <button
